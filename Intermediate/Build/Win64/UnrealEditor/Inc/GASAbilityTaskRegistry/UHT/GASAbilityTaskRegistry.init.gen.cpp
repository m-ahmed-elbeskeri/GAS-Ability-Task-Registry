	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_GASAbilityTaskRegistry()
	{
		if (!Z_Registration_Info_UPackage__Script_GASAbilityTaskRegistry.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_GASAbilityTaskRegistry_PreFinishSpawnDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_GASAbilityTaskRegistry_SpawnActorDelegate__DelegateSignature,
